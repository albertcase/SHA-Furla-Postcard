...
<head lang="en">
    ...
    <script type="text/javascript" src="/dist/js/form_all.min.js"></script>
</head>
...
<div class="wrapper">
    ...
    <div class="v-content animate fade">
        <div class="logo">
            <img src="/dist/images/logo.png" alt=""/>
        </div>
        <form id="form-contact">
            <h2 class="title"><img src="/dist/images/text-form-tips.png" alt=""/></h2>
            <div class="form-information">
                <div class="input-box input-box-name">
                    <input type="text" id="input-lastname" placeholder="姓..."/>
            ...
            <div class="btn btn-submit"><span>确认</span></div>
        </form>
        <div class="success-block hide">
            <div class="s-t1">
                <img src="/dist/images/tips-1.png" alt=""/>
            </div>
            <div class="btn btn-gohome"><span>我也要送好礼祝福</span></div>
        </div>
    </div>
</div>
